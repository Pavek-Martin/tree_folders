...
$array+="@echo off"
$array+="del "+$uvoz+"_TREE_folder_"+$fold+".txt"+$uvoz
#$array+=$fold
#$array+=".txt"
$array+="sleep 1"

$array+="date /t > "+$uvoz+$pwd2+"_TREE_folder_"+$fold+".txt"+$uvoz
$array+="time /t >> "+$uvoz+$pwd2+"_TREE_folder_"+$fold+".txt"+$uvoz
$array+="tree /F /A "+$uvoz+$pwd2+$uvoz+" >> "+$uvoz+$pwd2+"_TREE_folder_"+$fold+".txt"+$uvoz
$array+="@echo on"
$array+="REM pause"
